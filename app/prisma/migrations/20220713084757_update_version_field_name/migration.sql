/*
  ...
  - You are about to drop the column `versionId` on the `Unicode_Emoji` table. All the data in the column will be lost.
...
CREATE TABLE "new_Unicode_Emoji" (
    ...
    CONSTRAINT "Unicode_Emoji_unicode_Emoji_Version_fkey" FOREIGN KEY ("unicode_Emoji_Version") REFERENCES "Unicode_Emoji_Version" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
